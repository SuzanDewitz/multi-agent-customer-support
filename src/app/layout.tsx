          ...
          <header className="fixed w-full top-0 z-50 bg-white dark:bg-gray-900">
            <div className="w-full">
              <div className="text-center py-4">
                <h1 style={{ fontSize: '40px', fontWeight: 'bold', lineHeight: '1.2' }} className="text-gray-900 dark:text-white">
                  <Link href="/">
                    Multi-Agent Support
                  </Link>
                </h1>
              ...
              <div className="flex justify-end px-4 pb-4">
                <nav>
                  <ul className="flex space-x-8">
                    ...
                    <li><Link href="/login" className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">Sign In</Link></li>
                  </ul>
                </nav>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4">
              <div className="social-networks">
                <ul className="flex justify-center space-x-8">
                  <li>
                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 bg-gray-100 p-1 rounded-full hover:bg-gray-200 inline-block">
                  ...
                  <li>
                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 bg-gray-100 p-1 rounded-full hover:bg-gray-200 inline-block">
                      <svg className="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <li>
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 bg-gray-100 p-1 rounded-full hover:bg-gray-200 inline-block">
                      <svg className="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <p id="phone-number" className="mt-4 text-gray-600 dark:text-gray-300">Contact: +1 (555) 123-4567</p>
            </div>
          </footer>
